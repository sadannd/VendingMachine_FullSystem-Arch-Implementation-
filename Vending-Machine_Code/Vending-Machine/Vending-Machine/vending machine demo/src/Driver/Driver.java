...
//	 this is the driver which drives vending machine1 and vending machine 2
	...
	public static void main(String[] args) throws IOException {
		...
		if (input.equalsIgnoreCase("1")) {
			...
			AbstractFactory af = new VendingFactory1();
			DataStore ds = af.getDataStorage();
...
//				    in.next();
				    System.out.print("That�s not "
				     + "an integer between 0 - 7 or q. Try again:\n ");
				   continue;
				   }
				...
				switch (ch){
						...
						case 6: // set_price
							System.out.print(" Operation:set_price(float p)");
							System.out.print("\n");
							System.out.print(" Enter value of parameter p:");
							System.out.print("\n");
							try {
			...
			AbstractFactory af = new VendingFactory2();
			DataStore ds = af.getDataStorage();
			OutputProcessor op = new OutputProcessor(af, ds);
			MDAEFSM mda = new MDAEFSM(op);
			...
			while (true){
				System.out.print(" Select Operation: ");
				System.out.print("\n");
				System.out.print("0-CREATE,1-COIN,2-SUGAR,3-CREAM,4-COFFEE,5-InsertCups,6-SetPrice,7-CANCEL,8-CARD,q-Quit");
				System.out.print("\n");
